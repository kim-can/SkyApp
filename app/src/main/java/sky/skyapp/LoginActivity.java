...
public class LoginActivity extends SKYActivity<ILoginBiz> implements ILoginActivity, LoaderCallbacks<Cursor> {
	...
	@BindView(R.id.login_form) public View				mProgressView;

	@BindView(R.id.login_progress) public View			mLoginFormView;
